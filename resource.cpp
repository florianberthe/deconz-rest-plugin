...
const char *RConfigHeight = "config/height";
const char *RConfigHeightMax = "config/heightmax";
const char *RConfigHeightMin = "config/heightmin";
...
const char *RConfigLiquidHeight = "config/liquidheight";
...
void initResourceDescriptors()
{
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt16, QVariant::Double, RConfigHeight));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt16, QVariant::Double, RConfigHeightMax));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt16, QVariant::Double, RConfigHeightMin));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt16, QVariant::Double, RConfigLiquidHeight));
